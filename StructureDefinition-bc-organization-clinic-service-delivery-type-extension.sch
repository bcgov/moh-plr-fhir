...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'serviceDeliveryType']) &gt;= 1">extension with URL = 'serviceDeliveryType': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'serviceDeliveryType']) &lt;= 1">extension with URL = 'serviceDeliveryType': maximum cardinality of 'extension' is 1</sch:assert>
