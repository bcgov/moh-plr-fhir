...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'archiveDate']) &gt;= 1">extension with URL = 'archiveDate': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'archiveDate']) &lt;= 1">extension with URL = 'archiveDate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'displayFlag']) &gt;= 1">extension with URL = 'displayFlag': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'displayFlag']) &lt;= 1">extension with URL = 'displayFlag': maximum cardinality of 'extension' is 1</sch:assert>
