...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'sourcePractitioner']) &gt;= 1">extension with URL = 'sourcePractitioner': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'sourcePractitioner']) &lt;= 1">extension with URL = 'sourcePractitioner': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'targetPractitioner']) &gt;= 1">extension with URL = 'targetPractitioner': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'targetPractitioner']) &lt;= 1">extension with URL = 'targetPractitioner': maximum cardinality of 'extension' is 1</sch:assert>
